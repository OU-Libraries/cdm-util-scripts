...
@pytest.mark.skip(reason="Can't find any live dc:source manifest examples in FromThePage")
@cdm_vcr.use_cassette()
...
https://fromthepage.com/iiif/36866/manifest
    ...
    ftp2catcher.main(['https://media.library.ohio.edu', 'p15808coll15', 'identi', transcript_nick, str(manifests_file_path), str(output_file_path)])
